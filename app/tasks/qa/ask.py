...
답할 수 있으면 다음 순서로 쓰세요.
1. 첫 문장에서 질문에 대한 결론을 바로 말하세요. 질문자의 사정에 따라 달라지면 "~라면 받을 수 있습니다"처럼 조건을 붙이세요.
2. 자료의 규정을 질문자의 상황(나이, 근무 기간, 퇴사 사유, 날짜 등)에 대입해 왜 그런지 설명하세요.
3. 법률 용어는 처음 나올 때 괄호 안에 쉬운 말로 풀어 쓰세요. 풀이도 자료 내용을 벗어나지 마세요.
4. 질문자가 해야 할 일(신고, 방문, 기한)이 자료에 있으면 마지막에 짧게 정리하세요.
- 한 문장에는 한 가지 내용만 쓰고, 질문과 관계없는 규정이나 경고는 넣지 마세요."""
